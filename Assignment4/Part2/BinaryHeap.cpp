...
void BinaryHeap<ElementType>::resize(int newlen)
{
   ...
   if (newElements == nullptr){
      throw EmptyDataCollectionException("There is no available heap memory");
   }
...
void BinaryHeap<ElementType>::remove()
{
   ...
   if (elementCount == 0){
      throw EmptyDataCollectionException("There is nothing to remove: It is empty");
   }
   
   cout<<"This is what i removed: "<<arr[0]<<endl;
