...
private:
   ...
   //Description: Recursive copy that is used within the copy constructor (Added "helper function")
   BSTNode* copyTree(BSTNode*  sourceNode); 
   //Description: Recursive delete methpd that is used within the destructor (Added "helper function")
